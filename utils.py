...
def assign_to_gpus(num_gpus, num_folds, resolutions):
    """
    Assigns each fold of different nnU-Net model configurations to a GPU in a round-robin fashion.

    :param configurations: A list of nnU-Net model configurations (e.g., ['2d','3d_fullres','3d_lowres', '3d_cascade_fullres']).
